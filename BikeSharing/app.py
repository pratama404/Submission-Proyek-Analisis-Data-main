...
st.sidebar.markdown("**• Nama: Ageng Putra Pratama**")
st.sidebar.markdown(
    "**• Email: [agengputrapratama@gmail.com](agengputrapratama@gmail.com)**")
st.sidebar.markdown(
    "**• Dicoding: [agengputrapratama](https://www.dicoding.com/users/agengputrapratama/)**")
st.sidebar.markdown(
    "**• LinkedIn: [agengputrapratama](https://www.linkedin.com/in/agengputrapratama/)**")
